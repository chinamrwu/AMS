...
```{r DMRInf,echo=FALSE,results="asis",include=TRUE,knitr.table.format = 'html'}
      library(tidyr)
      library(kableExtra)
      library(xtable)
    ...
    for(i in 1:length(sites)){
       ...
       tbl <- obj[1:200,] %>%
         ...
         kable_styling(bootstrap_options = c("striped", "hover", "condensed","responsive"),full_width = T,font_size =12,fixed_thead=T)
       print(tbl)
       cat("\n")
    }
```
